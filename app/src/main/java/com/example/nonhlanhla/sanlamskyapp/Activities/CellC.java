...
public class CellC extends AppCompatActivity {

    Spinner cell_Spinner;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cell_c);


        cell_Spinner = findViewById(R.id.cell_Spinner);

        List<String> simpleList = Arrays.asList(getResources().getStringArray(R.array.cell_items));


        ArrayAdapter<String> simpleAdapter = new ArrayAdapter<>(CellC.this, R.layout.support_simple_spinner_dropdown_item,simpleList);
        cell_Spinner.setAdapter(simpleAdapter);




        cell_Spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                    ...
                    case 1:
                        Intent intent = new Intent(CellC.this, CellVend_1.class);
